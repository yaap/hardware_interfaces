...
/**
 * Request for the modem to perform a network scan with prioritization.
 *
 * <p>This parcelable contains information about networks that should be prioritized
 * during a modem-initiated network scan, along with parameters for the scan timing.
 * @hide
 */
...
parcelable PrioritizedNetworkScanRequest {
    /**
     * A list of {@link NetworkInfo} objects defining the preferred networks for the scan.
