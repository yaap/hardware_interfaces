...
/**
 * Configuration for satellite networks to be provided to the modem.
 *
 * <p>This parcelable carries information about satellite PLMNs, including their
 * supported technologies and frequencies, to help the modem prioritize registration
 * and identify satellite networks.
 * @hide
 */
@VintfStability
parcelable SatelliteNetworkInfo {
     ...
     * but modem reports SatelliteTechnology#NONE in the AccessTechnologySpecificInfo of the camped
     * cell, Android will consider this network as a terrestrial network. To make Android consider
     * this as a NTN network, modem must report SatelliteTechnology#NTN for such cases.
     *
