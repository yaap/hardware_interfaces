...
/**
 * Defines a PowerProfile for a Battery Supply PDO as defined by the USB Power Delivery
 * Specification
 */
@VintfStability
parcelable UsbPdBattery {
    /**
     ...
     * This field must be exactly the value of the "Maximum Allowable Power" field
     * in the Battery Supply PDO.
     *
     * The value is expected to be 0 or greater.
     */
    int maxPowerMw;
