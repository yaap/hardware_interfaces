...
BqrEnergyMonitoringEventV6::BqrEnergyMonitoringEventV6(const HalPacket& packet)
    ...
    is_valid_ = BqrEnergyMonitoringEvent::IsValid() && size() >= kEnergyMonitoringEventV6MinSize;
    ParseData();
}

void BqrEnergyMonitoringEventV6::ParseData() {
    if (is_valid_) {
        report_time_duration_ = AtUint32LittleEndian(EnergyMonitoringOffsetV6::kReportTimeDuration);
        ...
        tx_ipa_active_one_chain_time_ =
                AtUint32LittleEndian(EnergyMonitoringOffsetV6::kTxIpaActiveOneChainTime);
        tx_ipa_active_two_chain_time_ =
                AtUint32LittleEndian(EnergyMonitoringOffsetV6::kTxIpaActiveTwoChainTime);
        tx_xpa_active_one_chain_time_ =
                AtUint32LittleEndian(EnergyMonitoringOffsetV6::kTxXpaActiveOneChainTime);
        tx_xpa_active_two_chain_time_ =
                AtUint32LittleEndian(EnergyMonitoringOffsetV6::kTxXpaActiveTwoChainTime);
    }
}

bool BqrEnergyMonitoringEventV6::IsValid() const {
    return is_valid_;
}
...
std::string BqrEnergyMonitoringEventV6::ToBqrString() const {
    ...
    ss << BqrEnergyMonitoringEvent::ToBqrString() << ", Rpt_Dur: " << std::dec
       << report_time_duration_ << " ms, Rx_Act_1_Chain: " << rx_active_one_chain_time_
