...
struct HciPacketRescuerTestParam {
    ...
    std::function<void(MockBluetoothActivities&)> mock_setup = [](MockBluetoothActivities&) {};
};
...
class HciPacketRescuerParamTest : public HciPacketRescuerTest,
...
TEST_P(HciPacketRescuerParamTest, FindValidPacketOffset) {
    ...
    size_t offset = hci_packet_rescuer_->FindValidPacketOffset(std::span(param.data_stream));
...
INSTANTIATE_TEST_SUITE_P(
        ...
        Values(HciPacketRescuerTestParam{.test_name = "EmptyStream",
                                         .data_stream = {},
                                         .expected_offset = 0},
               ...
               HciPacketRescuerTestParam{
                       ...
                       .data_stream = {static_cast<uint8_t>(HciPacketType::kAclData), 0x23, 0x01},
                       .expected_offset = 0,
                       .mock_setup =
               ...
               HciPacketRescuerTestParam{
                       ...
                       .data_stream = {0xFF, 0xFF, static_cast<uint8_t>(HciPacketType::kAclData),
                                       0x23, 0x01},
                       .expected_offset = 2,
                       .mock_setup =
                               [](MockBluetoothActivities& mock) {
               ...
               HciPacketRescuerTestParam{
                       ...
                       .mock_setup =
                               [](MockBluetoothActivities& mock) {
                                   EXPECT_CALL(mock, IsConnected(0x0123)).WillOnce(Return(false));
                               }},
               HciPacketRescuerTestParam{
               ...
               HciPacketRescuerTestParam{
                       ...
                       .data_stream = {static_cast<uint8_t>(HciPacketType::kThreadData), 0x00, 0x00,
                                       0x01, 0x02, 0x85},
                       .expected_offset = 0},
               HciPacketRescuerTestParam{
                       .test_name = "ValidThreadPacketWithOffset",
                       .data_stream = {0xFF, 0xFA, 0xFB, 0xFC,
                                       static_cast<uint8_t>(HciPacketType::kThreadData), 0x00, 0x00,
                                       0x01, 0x02, 0x80},
                       .expected_offset = 4},
               HciPacketRescuerTestParam{
                       .test_name = "InvalidThreadPacket",
                       .data_stream = {static_cast<uint8_t>(HciPacketType::kThreadData), 0x01, 0x00,
                                       0x01, 0x02, 0x85},
                       .expected_offset = 6},
               HciPacketRescuerTestParam{
                       .test_name = "ValidEventPacketAtStart",
                       .data_stream = {static_cast<uint8_t>(HciPacketType::kEvent),
                                       static_cast<uint8_t>(EventCode::kCommandComplete), 0x05,
               ...
               HciPacketRescuerTestParam{
                       ...
                       .data_stream = {static_cast<uint8_t>(HciPacketType::kEvent), 0x01, 0x01},
                       .expected_offset = 3}),
