...
class BluetoothChannelSoundingSessionCallback : public BnBluetoothChannelSoundingSessionCallback {
  public:
...
ScopedAStatus BluetoothChannelSoundingSessionCallback::onOpened(Reason /*reason*/) {
    return ::ndk::ScopedAStatus::ok();
}
ScopedAStatus BluetoothChannelSoundingSessionCallback::onOpenFailed(Reason /*reason*/) {
    return ::ndk::ScopedAStatus::ok();
}
...
ScopedAStatus BluetoothChannelSoundingSessionCallback::onClose(Reason /*reason*/) {
    return ::ndk::ScopedAStatus::ok();
}
ScopedAStatus BluetoothChannelSoundingSessionCallback::onCloseFailed(Reason /*reason*/) {
    return ::ndk::ScopedAStatus::ok();
}
...
class BluetoothRangingTest : public ::testing::TestWithParam<std::string> {
  public:
    ...
    ScopedAStatus getSupportedSessionTypes(std::optional<std::vector<SessionType>>* _aidl_return);
    ScopedAStatus getMaxSupportedCsSecurityLevel(CsSecurityLevel* _aidl_return);
    ScopedAStatus getSupportedCsSecurityLevels(std::vector<CsSecurityLevel>* _aidl_return);
    ...
    ScopedAStatus initBluetoothChannelSoundingSession(
        ...
        callback = ndk::SharedRefBase::make<BluetoothChannelSoundingSessionCallback>();
    ...
    RangingHalVersion GetRangingHalVersion() {
        ...
        auto aidl_ret_val = bluetooth_channel_sounding_->getInterfaceVersion(&aidl_version);
...
ScopedAStatus BluetoothRangingTest::getMaxSupportedCsSecurityLevel(CsSecurityLevel* _aidl_return) {
    return bluetooth_channel_sounding_->getMaxSupportedCsSecurityLevel(_aidl_return);
}

ScopedAStatus BluetoothRangingTest::getSupportedCsSecurityLevels(
        std::vector<CsSecurityLevel>* _aidl_return) {
    return bluetooth_channel_sounding_->getSupportedCsSecurityLevels(_aidl_return);
}
...
ScopedAStatus BluetoothRangingTest::openSession(
        ...
        const std::shared_ptr<IBluetoothChannelSoundingSessionCallback>& in_callback,
        std::shared_ptr<IBluetoothChannelSoundingSession>* _aidl_return) {
    return bluetooth_channel_sounding_->openSession(in_params, in_callback, _aidl_return);
}
...
TEST_P(BluetoothRangingTest, GetSupportedCsSecurityLevels) {
    ...
    ScopedAStatus status = getSupportedCsSecurityLevels(&supported_security_levels);
...
INSTANTIATE_TEST_SUITE_P(
        PerInstance, BluetoothRangingTest,
        testing::ValuesIn(android::getAidlHalInstanceNames(IBluetoothChannelSounding::descriptor)),
