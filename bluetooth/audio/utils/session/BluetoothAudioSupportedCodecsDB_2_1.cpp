...
GetSoftwarePcmCapabilities_2_1() {
    return std::vector<::android::hardware::bluetooth::audio::V2_1::PcmParameters>(
...
std::vector<CodecCapabilities> GetOffloadCodecCapabilities(
    ...
    if (is_2_0_session_type(session_type)) {
        return GetOffloadCodecCapabilities(static_cast<SessionType_2_0>(session_type));
    }
    return std::vector<CodecCapabilities>(0);
}

bool IsSoftwarePcmConfigurationValid_2_1(
        const ::android::hardware::bluetooth::audio::V2_1::PcmParameters& pcm_config) {
    if ((pcm_config.sampleRate != SampleRate_2_1::RATE_44100 &&
        ...
        return false;
    } else if (pcm_config.sampleRate & kDefaultSoftwarePcmCapabilities_2_1.sampleRate &&
               pcm_config.bitsPerSample & kDefaultSoftwarePcmCapabilities_2_1.bitsPerSample &&
               pcm_config.channelMode & kDefaultSoftwarePcmCapabilities_2_1.channelMode &&
...
bool IsOffloadCodecConfigurationValid(
        const ::android::hardware::bluetooth::audio::V2_1::SessionType& session_type,
        const ::android::hardware::bluetooth::audio::V2_0::CodecConfiguration& codec_config) {
    if (is_2_0_session_type(session_type)) {
        return IsOffloadCodecConfigurationValid(static_cast<SessionType_2_0>(session_type),
                                                codec_config);
    }
