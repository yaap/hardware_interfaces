...
using SessionType_2_0 = ::android::hardware::bluetooth::audio::V2_0::SessionType;
...
BluetoothAudioSession_2_1::BluetoothAudioSession_2_1(
    ...
    if (is_2_0_session_type(session_type) || is_unsupported_2_1_session_type(session_type)) {
...
std::shared_ptr<BluetoothAudioSession> BluetoothAudioSession_2_1::GetAudioSession() {
...
BluetoothAudioSession_2_1::GetAudioConfig() {
    ...
    if (audio_session->IsSessionReady()) {
        ...
        if (session_type_2_1_ != SessionType_2_1::UNKNOWN) return audio_config_2_1_;
        ...
        if (fromConf.getDiscriminator() == AudioConfiguration::hidl_discriminator::codecConfig) {
            toConf.codecConfig(fromConf.codecConfig());
        } else {
            toConf.pcmConfig() = {
                    .sampleRate =
                            static_cast<::android::hardware::bluetooth::audio::V2_1::SampleRate>(
        ...
        return toConf;
    } else if (session_type_2_1_ == SessionType_2_1::A2DP_HARDWARE_OFFLOAD_DATAPATH) {
...
bool BluetoothAudioSession_2_1::UpdateAudioConfig(
        const ::android::hardware::bluetooth::audio::V2_1::AudioConfiguration& audio_config) {
    bool is_software_session =
            (session_type_2_1_ == SessionType_2_1::A2DP_SOFTWARE_ENCODING_DATAPATH ||
             session_type_2_1_ == SessionType_2_1::HEARING_AID_SOFTWARE_ENCODING_DATAPATH ||
             session_type_2_1_ == SessionType_2_1::LE_AUDIO_SOFTWARE_ENCODING_DATAPATH ||
             session_type_2_1_ == SessionType_2_1::LE_AUDIO_SOFTWARE_DECODED_DATAPATH);
...
void BluetoothAudioSession_2_1::OnSessionStarted(
    ...
    if (session_type_2_1_ == SessionType_2_1::UNKNOWN) {
        ...
        if (audio_config.getDiscriminator() ==
            ...
            config.pcmConfig(::android::hardware::bluetooth::audio::V2_0::PcmParameters{
...
std::unique_ptr<BluetoothAudioSessionInstance_2_1> BluetoothAudioSessionInstance_2_1::instance_ptr =
        std::unique_ptr<BluetoothAudioSessionInstance_2_1>(new BluetoothAudioSessionInstance_2_1());

// API to fetch the session of A2DP / Hearing Aid
std::shared_ptr<BluetoothAudioSession_2_1> BluetoothAudioSessionInstance_2_1::GetSessionInstance(
