...
class BluetoothAudioSessionControl_2_1 {
  ...
  public:
    ...
    static uint16_t RegisterControlResultCback(const SessionType_2_1& session_type,
    ...
    static void UnregisterControlResultCback(const SessionType_2_1& session_type, uint16_t cookie) {
        std::shared_ptr<BluetoothAudioSession_2_1> session_ptr =
                BluetoothAudioSessionInstance_2_1::GetSessionInstance(session_type);
        if (session_ptr != nullptr) {
    ...
    // AudioConfiguration
    static const AudioConfiguration_2_1 GetAudioConfig(const SessionType_2_1& session_type) {
        std::shared_ptr<BluetoothAudioSession_2_1> session_ptr =
                BluetoothAudioSessionInstance_2_1::GetSessionInstance(session_type);
        if (session_ptr != nullptr) {
            return session_ptr->GetAudioConfig();
        } else if (session_type == SessionType_2_1::A2DP_HARDWARE_OFFLOAD_DATAPATH) {
    ...
    static void UpdateTracksMetadata(const SessionType_2_1& session_type,
    ...
    static size_t OutWritePcmData(const SessionType_2_1& session_type, const void* buffer,
                                  size_t bytes) {
        std::shared_ptr<BluetoothAudioSession_2_1> session_ptr =
                BluetoothAudioSessionInstance_2_1::GetSessionInstance(session_type);
        if (session_ptr != nullptr) {
    ...
    static size_t InReadPcmData(const SessionType_2_1& session_type, void* buffer, size_t bytes) {
        std::shared_ptr<BluetoothAudioSession_2_1> session_ptr =
                BluetoothAudioSessionInstance_2_1::GetSessionInstance(session_type);
        if (session_ptr != nullptr) {
