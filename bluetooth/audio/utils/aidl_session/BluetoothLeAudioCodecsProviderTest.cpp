...
using aidl::android::hardware::bluetooth::audio::setting::CodecConfigurationList;
...
using aidl::android::hardware::bluetooth::audio::setting::StrategyConfigurationList;

typedef std::tuple<std::vector<ScenarioList>, std::vector<ConfigurationList>,
                   std::vector<CodecConfigurationList>, std::vector<StrategyConfigurationList>>
        OffloadSetting;
...
static const Scenario kValidBroadcastScenario(std::nullopt, std::nullopt,
                                              std::make_optional("BcastStereo_16_2"));

static const Scenario kValidAsymmetricScenario(std::make_optional("OneChanStereo_32_1"),
...
// CodecConfiguration
static const CodecConfiguration kValidCodecLC3_16k_1(std::make_optional("LC3_16k_1"),
                                                     std::make_optional(CodecType::LC3),
                                                     std::nullopt, std::make_optional(16000),
                                                     std::make_optional(7500),
                                                     std::make_optional(30), std::nullopt);

static const CodecConfiguration kValidCodecLC3_32k_1(std::make_optional("LC3_32k_1"),
                                                     std::make_optional(CodecType::LC3),
                                                     std::nullopt, std::make_optional(32000),
                                                     std::make_optional(7500),
                                                     std::make_optional(30), std::nullopt);

// StrategyConfiguration
static const StrategyConfiguration kValidStrategyStereoOneCis(
        std::make_optional("STEREO_ONE_CIS_PER_DEVICE"), std::make_optional(AudioLocation::STEREO),
...
static const StrategyConfiguration kValidStrategyStereoTwoCis(
        ...
        std::make_optional(AudioLocation::STEREO), std::make_optional(1), std::make_optional(2),
        std::nullopt);
static const StrategyConfiguration kValidStrategyMonoOneCis(
        std::make_optional("MONO_ONE_CIS_PER_DEVICE"), std::make_optional(AudioLocation::MONO),
        std::make_optional(1), std::make_optional(1), std::nullopt);
static const StrategyConfiguration kValidStrategyBroadcastStereo(
        std::make_optional("BROADCAST_STEREO"), std::make_optional(AudioLocation::STEREO),
        std::make_optional(0), std::make_optional(2), std::nullopt);

static const StrategyConfiguration kValidStrategyStereoOneCisInt(
        std::make_optional("STEREO_ONE_CIS_PER_DEVICE"), std::nullopt, std::make_optional(2),
        std::make_optional(1), std::make_optional(3));
static const StrategyConfiguration kValidStrategyStereoTwoCisInt(
        std::make_optional("STEREO_TWO_CISES_PER_DEVICE"), std::nullopt, std::make_optional(1),
        std::make_optional(2), std::make_optional(3));
static const StrategyConfiguration kValidStrategyMonoOneCisInt(
        std::make_optional("MONO_ONE_CIS_PER_DEVICE"), std::nullopt, std::make_optional(1),
...
static const StrategyConfiguration kValidStrategyBroadcastStereoBoth(
        std::make_optional("BROADCAST_STEREO"), std::make_optional(AudioLocation::STEREO),
        std::make_optional(0), std::make_optional(2), std::make_optional(3));

// List of all invalid strategy configuration
const auto kInvalidStrategyStereoTwoCisTwoDevice =
        StrategyConfigurationList(std::vector<StrategyConfiguration>{
                StrategyConfiguration(std::make_optional("STEREO_ONE_CIS_PER_DEVICE"),
                                      std::make_optional(AudioLocation::STEREO),
                                      std::make_optional(2), std::make_optional(2), std::nullopt)});
const auto kInvalidStrategyMonoTwoCisTwoDevice =
        StrategyConfigurationList(std::vector<StrategyConfiguration>{
                StrategyConfiguration(std::make_optional("MONO_ONE_CIS_PER_DEVICE"),
                                      std::make_optional(AudioLocation::STEREO),
                                      std::make_optional(2), std::make_optional(2), std::nullopt)});
const auto kInvalidStrategyNoName = StrategyConfigurationList(std::vector<StrategyConfiguration>{
        StrategyConfiguration(std::nullopt, std::make_optional(AudioLocation::STEREO),
                              std::make_optional(2), std::make_optional(1), std::nullopt)});
const auto kInvalidStrategyNoLocation =
        StrategyConfigurationList(std::vector<StrategyConfiguration>{
                StrategyConfiguration(std::make_optional("STEREO_ONE_CIS_PER_DEVICE"), std::nullopt,
                                      std::make_optional(2), std::make_optional(1), std::nullopt)});
const auto kInvalidStrategyNoDevice = StrategyConfigurationList(std::vector<StrategyConfiguration>{
        StrategyConfiguration(std::make_optional("STEREO_ONE_CIS_PER_DEVICE"),
                              std::make_optional(AudioLocation::STEREO), std::nullopt,
                              std::make_optional(1), std::nullopt)});
const auto kInvalidStrategyNoChannel = StrategyConfigurationList(std::vector<StrategyConfiguration>{
        StrategyConfiguration(std::make_optional("STEREO_ONE_CIS_PER_DEVICE"),
                              std::make_optional(AudioLocation::STEREO), std::make_optional(2),
                              std::nullopt, std::nullopt)});
const auto kInvalidStrategyIntMoreBitmask =
        StrategyConfigurationList(std::vector<StrategyConfiguration>{StrategyConfiguration(
                std::make_optional("STEREO_ONE_CIS_PER_DEVICE"),
                std::make_optional(AudioLocation::STEREO), std::make_optional(2),
                std::make_optional(1), std::make_optional(7))});
const auto kInvalidStrategyIntStereoTwoCisTwoDevice =
        StrategyConfigurationList(std::vector<StrategyConfiguration>{StrategyConfiguration(
                std::make_optional("STEREO_ONE_CIS_PER_DEVICE"), std::nullopt,
                std::make_optional(2), std::make_optional(2), std::make_optional(3))});
const auto kInvalidStrategyIntMonoTwoCisTwoDevice =
        StrategyConfigurationList(std::vector<StrategyConfiguration>{StrategyConfiguration(
                std::make_optional("MONO_ONE_CIS_PER_DEVICE"), std::nullopt, std::make_optional(2),
                std::make_optional(2), std::make_optional(4))});
const auto kInvalidStrategyIntBroadcast =
        StrategyConfigurationList(std::vector<StrategyConfiguration>{StrategyConfiguration(
                std::make_optional("MONO_ONE_CIS_PER_DEVICE"), std::nullopt, std::make_optional(0),
                std::make_optional(1), std::make_optional(3))});
const auto kInvalidStrategyBothStereoMonoInt =
        StrategyConfigurationList(std::vector<StrategyConfiguration>{StrategyConfiguration(
                std::make_optional("STEREO_ONE_CIS_PER_DEVICE"),
                std::make_optional(AudioLocation::STEREO), std::make_optional(2),
                std::make_optional(1), std::make_optional(4))});
...
static const std::vector<ScenarioList> kValidScenarioList = {
        ScenarioList(std::vector<Scenario>{kValidScenario, kValidBroadcastScenario})};
static const std::vector<ConfigurationList> kValidConfigurationList = {
        ConfigurationList(std::vector<Configuration>{kValidConfigOneChanStereo_16_1})};
static const std::vector<CodecConfigurationList> kValidCodecConfigurationList = {
        CodecConfigurationList(std::vector<CodecConfiguration>{kValidCodecLC3_16k_1})};

static const std::vector<StrategyConfigurationList> kValidStrategyConfigurationList = {
        StrategyConfigurationList(std::vector<StrategyConfiguration>{
                kValidStrategyStereoOneCis, kValidStrategyStereoTwoCis, kValidStrategyMonoOneCis,
                kValidStrategyBroadcastStereo, kValidStrategyStereoOneCisInt,
                kValidStrategyStereoTwoCisInt, kValidStrategyMonoOneCisInt,
                kValidStrategyBroadcastStereoInt, kValidStrategyStereoOneCisBoth,
                kValidStrategyStereoTwoCisBoth, kValidStrategyMonoOneCisBoth,
                kValidStrategyBroadcastStereoBoth})};
...
static const std::vector<ConfigurationList> kValidAsymmetricConfigurationList = {
        ConfigurationList(std::vector<Configuration>{kValidConfigOneChanStereo_16_1,
                                                     kValidConfigOneChanStereo_32_1})};
static const std::vector<CodecConfigurationList> kValidAsymmetricCodecConfigurationList = {
        CodecConfigurationList(
                std::vector<CodecConfiguration>{kValidCodecLC3_16k_1, kValidCodecLC3_32k_1})};

class BluetoothLeAudioCodecsProviderTest : public ::testing::TestWithParam<OffloadSetting> {
  public:
    static std::vector<OffloadSetting> CreateTestCases(
            ...
            const std::vector<StrategyConfigurationList>& strategy_configuration_lists) {
        ...
        for (const auto& scenario_list : scenario_lists) {
            for (const auto& configuration_list : configuration_lists) {
                for (const auto& codec_configuration_list : codec_configuration_lists) {
                    for (const auto& strategy_configuration_list : strategy_configuration_lists) {
                        test_cases.push_back(CreateTestCase(scenario_list, configuration_list,
                                                            codec_configuration_list,
  ...
  protected:
    ...
    std::vector<LeAudioCodecCapabilitiesSetting> RunTestCase() {
        ...
        LeAudioOffloadSetting le_audio_offload_setting(scenario_lists, configuration_lists,
                                                       codec_configuration_lists,
    ...
    std::unordered_map<SessionType, std::vector<CodecInfo>> RunCodecInfoTestCase() {
        auto& [scenario_lists, configuration_lists, codec_configuration_lists,
               strategy_configuration_lists] = GetParam();
        LeAudioOffloadSetting le_audio_offload_setting(scenario_lists, configuration_lists,
                                                       codec_configuration_lists,
        ...
        BluetoothLeAudioCodecsProvider::SetLeAudioOffloadSettingForTesting(
                std::make_optional(std::move(le_audio_offload_setting)));
        auto le_audio_codec_capabilities = BluetoothLeAudioCodecsProvider::GetLeAudioCodecInfo();
        return le_audio_codec_capabilities;
    }

  private:
    static inline OffloadSetting CreateTestCase(
            const ScenarioList& scenario_list, const ConfigurationList& configuration_list,
            const CodecConfigurationList& codec_configuration_list,
            const StrategyConfigurationList& strategy_configuration_list) {
        return std::make_tuple(std::vector<ScenarioList>{scenario_list},
  ...
  public:
    static std::vector<ScenarioList> CreateInvalidScenarios() {
        ...
        invalid_scenario_test_cases.push_back(ScenarioList(std::vector<Scenario>{
                Scenario(std::nullopt, std::make_optional("OneChanStereo_16_1"), std::nullopt)}));

        invalid_scenario_test_cases.push_back(ScenarioList(std::vector<Scenario>{
                Scenario(std::make_optional("OneChanStereo_16_1"), std::nullopt, std::nullopt)}));

        invalid_scenario_test_cases.push_back(ScenarioList(
                std::vector<Scenario>{Scenario(std::nullopt, std::nullopt, std::nullopt)}));
...
class UpdateConfigurationsToMapTest : public BluetoothLeAudioCodecsProviderTest {
  public:
    static std::vector<ConfigurationList> CreateInvalidConfigurations() {
        ...
        invalid_configuration_test_cases.push_back(ConfigurationList(std::vector<Configuration>{
                Configuration(std::nullopt, std::make_optional("LC3_16k_1"),
                              std::make_optional("STEREO_ONE_CIS_PER_DEVICE"))}));

        invalid_configuration_test_cases.push_back(ConfigurationList(std::vector<Configuration>{
                Configuration(std::make_optional("OneChanStereo_16_1"), std::nullopt,
                              std::make_optional("STEREO_ONE_CIS_PER_DEVICE"))}));
  ...
  public:
    static std::vector<CodecConfigurationList> CreateInvalidCodecConfigurations() {
        ...
        invalid_codec_configuration_test_cases.push_back(
                CodecConfigurationList(std::vector<CodecConfiguration>{CodecConfiguration(
                        std::nullopt, std::make_optional(CodecType::LC3), std::nullopt,
                        std::make_optional(16000), std::make_optional(7500), std::make_optional(30),
                        std::nullopt)}));
...
class ComposeLeAudioAymmetricCodecInfoTest : public BluetoothLeAudioCodecsProviderTest {
  public:
};
...
TEST_P(ComposeLeAudioAymmetricCodecInfoTest, AsymmetricCodecInfoNotEmpty) {
    ...
    ASSERT_TRUE(!le_audio_codec_info_map[SessionType::LE_AUDIO_HARDWARE_OFFLOAD_ENCODING_DATAPATH]
                         .empty());
    ASSERT_TRUE(!le_audio_codec_info_map[SessionType::LE_AUDIO_HARDWARE_OFFLOAD_DECODING_DATAPATH]
                         .empty());
    auto required_flag = ConfigurationFlags();
    required_flag.bitmask |= ConfigurationFlags::ALLOW_ASYMMETRIC_CONFIGURATIONS;

    auto codec_info =
            le_audio_codec_info_map[SessionType::LE_AUDIO_HARDWARE_OFFLOAD_ENCODING_DATAPATH][0];
    ...
    codec_info =
            le_audio_codec_info_map[SessionType::LE_AUDIO_HARDWARE_OFFLOAD_DECODING_DATAPATH][0];
    ASSERT_EQ(codec_info.transport.getTag(), CodecInfo::Transport::Tag::leAudio);
...
INSTANTIATE_TEST_SUITE_P(BluetoothLeAudioCodecsProviderTest, GetScenariosTest,
                         ::testing::ValuesIn(BluetoothLeAudioCodecsProviderTest::CreateTestCases(
                                 GetScenariosTest::CreateInvalidScenarios(),
...
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(ComposeLeAudioAymmetricCodecInfoTest);
INSTANTIATE_TEST_SUITE_P(BluetoothLeAudioCodecsProviderTest, ComposeLeAudioAymmetricCodecInfoTest,
                         ::testing::ValuesIn(BluetoothLeAudioCodecsProviderTest::CreateTestCases(
