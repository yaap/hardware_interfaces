...
A2dpSoftwareAudioProvider BluetoothAudioProvidersFactory::a2dp_software_provider_instance_;
A2dpOffloadAudioProvider BluetoothAudioProvidersFactory::a2dp_offload_provider_instance_;
HearingAidAudioProvider BluetoothAudioProvidersFactory::hearing_aid_provider_instance_;
LeAudioOutputAudioProvider BluetoothAudioProvidersFactory::leaudio_output_provider_instance_;
LeAudioInputAudioProvider BluetoothAudioProvidersFactory::leaudio_input_provider_instance_;

Return<void> BluetoothAudioProvidersFactory::openProvider(const V2_0::SessionType sessionType,
...
Return<void> BluetoothAudioProvidersFactory::openProvider_2_1(const SessionType sessionType,
...
Return<void> BluetoothAudioProvidersFactory::getProviderCapabilities(
    ...
    hidl_vec<V2_0::AudioCapabilities> audio_capabilities = hidl_vec<V2_0::AudioCapabilities>(0);
    if (sessionType == V2_0::SessionType::A2DP_HARDWARE_OFFLOAD_DATAPATH) {
        ...
        std::vector<::android::hardware::bluetooth::audio::V2_0::PcmParameters>
                db_pcm_capabilities = android::bluetooth::audio::GetSoftwarePcmCapabilities();
        if (db_pcm_capabilities.size() == 1) {
            audio_capabilities.resize(1);
            audio_capabilities[0].pcmCapabilities(db_pcm_capabilities[0]);
        }
    }
    LOG(INFO) << __func__ << " - SessionType=" << toString(sessionType) << " supports "
              << audio_capabilities.size() << " codecs";
...
Return<void> BluetoothAudioProvidersFactory::getProviderCapabilities_2_1(
    ...
    hidl_vec<AudioCapabilities> audio_capabilities = hidl_vec<AudioCapabilities>(0);
    ...
    } else if (sessionType != SessionType::LE_AUDIO_HARDWARE_OFFLOAD_ENCODING_DATAPATH &&
               sessionType != SessionType::LE_AUDIO_HARDWARE_OFFLOAD_DECODING_DATAPATH &&
