...
namespace {
constexpr SampleRate a2dp_sample_rates[5] = {SampleRate::RATE_UNKNOWN, SampleRate::RATE_44100,
  ...
  public:
    ...
    std::vector<CodecSpecificConfig> GetSbcCodecSpecificSupportedList(bool supported) {
        ...
        std::vector<SampleRate> sample_rates =
                ExtractValuesFromBitmask<SampleRate>(sbc_capability.sampleRate, 0xff, supported);
    ...
    std::vector<CodecSpecificConfig> GetAacCodecSpecificSupportedList(bool supported) {
        ...
        std::vector<SampleRate> sample_rates =
                ExtractValuesFromBitmask<SampleRate>(aac_capability.sampleRate, 0xff, supported);
    ...
    std::vector<CodecSpecificConfig> GetLdacCodecSpecificSupportedList(bool supported) {
        ...
        std::vector<SampleRate> sample_rates =
                ExtractValuesFromBitmask<SampleRate>(ldac_capability.sampleRate, 0xff, supported);
    ...
    std::vector<CodecSpecificConfig> GetAptxCodecSpecificSupportedList(bool is_hd, bool supported) {
        ...
        std::vector<SampleRate> sample_rates =
                ExtractValuesFromBitmask<SampleRate>(aptx_capability.sampleRate, 0xff, supported);
        std::vector<ChannelMode> channel_modes =
