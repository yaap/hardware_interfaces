...
const size_t header_size_for_type[] = {
        0, kCommandHeaderSize, kAclHeaderSize, kScoHeaderSize, kEventHeaderSize, kIsoHeaderSize};
...
size_t HciGetPacketLengthForType(PacketType type, const std::vector<uint8_t>& header) {
...
bool HciPacketizer::OnDataReady(PacketType packet_type, const std::vector<uint8_t>& buffer,
                                size_t* offset) {
