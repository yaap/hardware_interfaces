...
Return<void> BluetoothHci::initialize_1_1(const ::android::sp<V1_1::IBluetoothHciCallbacks>& cb) {
    ...
    if (!rc) {
        auto hidl_status = cb->initializationComplete(V1_0::Status::INITIALIZATION_ERROR);
        if (!hidl_status.isOk()) {
...
class OldCbWrapper : public V1_1::IBluetoothHciCallbacks {
  public:
    ...
    OldCbWrapper(const ::android::sp<V1_0::IBluetoothHciCallbacks>& old_cb) : old_cb_(old_cb) {}
    ...
    Return<void> hciEventReceived(const ::android::hardware::hidl_vec<uint8_t>& event) override {
    ...
    Return<void> isoDataReceived(const ::android::hardware::hidl_vec<uint8_t>&) override {
        ALOGE("Please use HAL V1_1 for ISO.");
        return Void();
    };
};

Return<void> BluetoothHci::initialize(const ::android::sp<V1_0::IBluetoothHciCallbacks>& cb) {
