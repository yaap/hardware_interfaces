...
/**
 * A successful result for a face authenticate operation.
 *
 * @hide
 */
@VintfStability
parcelable AuthenticateSuccess {
    /** Face that was successfully accepted. */
    int enrollmentId;
     ...
     * they may use the vendor codes in ISessionCallback#onAuthenticationFrame(AuthenticationFrame)
