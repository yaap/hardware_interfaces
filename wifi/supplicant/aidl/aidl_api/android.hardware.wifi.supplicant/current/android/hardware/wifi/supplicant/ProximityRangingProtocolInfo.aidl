...
parcelable ProximityRangingProtocolInfo {
  ...
  android.hardware.wifi.supplicant.RttBw maxSupportedPacketBandwidthEdcaBased;
  android.hardware.wifi.supplicant.RttPreamble maxSupportedPreambleEdcaBased;
  android.hardware.wifi.supplicant.RttBw maxSupportedPacketBandwidthNtb;
  android.hardware.wifi.supplicant.RttPreamble maxSupportedPreambleNtb;
